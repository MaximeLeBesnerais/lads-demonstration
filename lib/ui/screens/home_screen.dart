...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static final List<Widget> _widgetOptions = <Widget>[
    const Center(child: Text('Nodes Screen Placeholder')), // Replace with NodesScreen()
    const Center(child: Text('Tasks Screen Placeholder')), // Replace with TasksScreen()
    const Center(child: Text('Logs Screen Placeholder')),  // Replace with LogsScreen()
    // Add AI Screen Placeholder if needed
  ];
        ...
        body: Row(
          children: <Widget>[
            ...
            NavigationRail(
              ...
              leading: const Padding( // Optional: Add a logo or title at the top
